...
class WeatherAgent:
    def __init__(self):
        ...
        # --- PHASE 3: Initialize a persistent Chat Session ---
        # We attach the tools directly to the chat session so it remembers them globally
    ...
    def _send_message(self, content):
        ...
        # Instead of generate_content, we send messages to the ongoing chat session
            ...
            if response.function_calls:
                for tool_call in response.function_calls:
                    if tool_call.name == "get_weather":
                        ...
                        # The chat session automatically remembers the original question!
...
if __name__ == "__main__":
    ...
    print("-" * 50)
    print("🌟 Enterprise Agent Ready (With Memory & Auto-Retry). Type 'exit' to quit.")
    print("-" * 50)
